...
public class BoardController {
	...
	public void modifyPagingGET(@RequestParam("bno") int bno, Model model, @ModelAttribute("cri") Criteria cri) throws Exception{
		
		model.addAttribute(service.read(bno));
	}
	
	@RequestMapping(value = "/modifyPage", method = RequestMethod.POST)
	public String modifyPagingPOST(BoardVO board, RedirectAttributes rttr, @ModelAttribute("cri") Criteria cri) throws Exception{
